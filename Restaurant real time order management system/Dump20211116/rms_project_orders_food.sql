...
CREATE TABLE `orders_food` (
  ...
  KEY `food_id` (`food_id`),
  CONSTRAINT `orders_food_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE,
  CONSTRAINT `orders_food_ibfk_2` FOREIGN KEY (`food_id`) REFERENCES `food` (`id`) ON DELETE CASCADE
...
INSERT INTO `orders_food` VALUES ('2021-11-16 01:32:43',1,5);
...
-- Dump completed on 2021-11-16  1:54:52
